...
public class JMCh12Exercises
{
    ...
    public boolean[] prob2abcdTrueFalse()
    {
        ...
        // to question (a) - (d)
        return new boolean[] { false, true, false, true }; // TODO fix this!!
    }
    ...
    public char getRandomRps()
    {
        ...
        char[] rps = new char[] { 'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's',
            's', 's', 's', 's', 's' };

        return rps[(int)( Math.random() * 14 )]; // TODO fix this!!
    }
    ...
    public static int[] makePythagoreanTriple( int m, int n )
    {
        ...
        return new int[] { m * m - n * n, 2 * m * n, m * m + n * n }; // TODO
                                                                      // fix
                                                                      // this!!
    }
    ...
    public static int computeScore( String word )
    {
        ...
        for ( int i = 0; i < word.length(); i++ )
        {
            ...
            sum += letterScores[alphabet.indexOf( c )];
        }
    ...
    public static double averageTopTwo( int[] scores )
    {
        ...
        for ( i = 2; i < size; i++ )
        {
            ...
            else if ( false /* _______________________ */ )
            {
